...
class Connection
{
    ...
    public static function connection(): PDO
    {
        ...
        try {
            ...
            static::$pdo = new PDO(
                'pgsql:host=localhost;port=5432;dbname=willian_db', # DSN (Data Source Name) para PostgreSQL.
                'willian', # Nome de usuário do banco de dados.
                'willian', # Senha do banco de dados.
